...
namespace Clase2.WinForm
{
    public partial class Form1 : Form
    {
        ...
        {
            string idEquipoSeleccionado = ObtenerIdEquipoSeleccionado();

            if (string.IsNullOrEmpty(idEquipoSeleccionado))
            {
            ...
            {
                // URL de destino
                string url = $"https://localhost:7169/api/Equipos/{idEquipoSeleccionado}";
        ...
        private String ObtenerIdEquipoSeleccionado()
        {
